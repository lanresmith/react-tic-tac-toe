This project was bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app). It contains solutions to the assignments of the [official React introductory tutorial](https://reactjs.org/tutorial/tutorial.html).
